  ...
  "whiteknight": {
    ...
    "remainingAccounts": {
      ...
      "wk_claim_token_batch": {
        "_comment": "Exactly five accounts per user. The RUSH and cbBTC ATAs both belong to the wk_auth shard PDA; the wallet cannot claim Sat Rush token-vault shares directly because that PDA must sign.",
        "perUser": [
          5
        ],
        "order": [
